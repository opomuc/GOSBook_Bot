...
def get_numberoftestsubs(bot, update):
	id = update.message.chat_id
	bot.sendMessage(chat_id = id, text = "Количество БЕТА-тестеров у этого бота: " + str(len(users.get_testsubs())))
...
def get_numberofsubs(bot, update):
	id = update.message.chat_id
	bot.sendMessage(chat_id = id, text = "Количество подписчиков у этого бота: " + str(len(users.get_subscribers())))
...
def get_numberofstarters(bot, update):
	id = update.message.chat_id
	bot.sendMessage(chat_id = id, text = "Количество стартеров у этого бота: " + str(len(users.get_starters())))
